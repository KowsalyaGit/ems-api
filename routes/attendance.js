...
attendance.route('/getCoursewiseAttendance/:Course/:AType/:Semester/:Section/:Session/:FromDate/:ToDate').get(attendanceController.getCoursewiseAttendance);
attendance.route('/getOverAllAttendance/:CouType/:AType/:Session/:FromDate/:ToDate').get(attendanceController.getOverAllAttendance);
